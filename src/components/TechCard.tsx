...
export const TechCard = ({tech}: {tech: SkilsTech}) => {
    return (
        <Card className="h-44 w-full bg-card p- border-2 border-border hover:border-primary/50 transition-all duration-300 hover:shadow-xl shadow-lg">
            <CardContent className="flex flex-col items-center justify-center h-full  gap-3">
                ...
                <div className="text-center">
                    <h3 className="font-bold text-lg md:text-2xl text-primary-foreground mb-2">{tech.name}</h3>
                </div>
            </CardContent>
        </Card>
    )
